...
p + stat_boxplot(geom = "errorbar", width = 0.6, aes(x = group, y = Intensity, group = group)) +
  geom_boxplot(aes(x = group, y = Intensity, group = group, fill = factor(group)), color = "black") + theme(legend.position = "none")
```
