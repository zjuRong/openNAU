...
data_raw_QC <- read.csv("sample_mass_RC_QC_normalize_zscore.csv")
...
<a href="DMC_wilcox_opls_mean.csv">Download data of differential metabolites</a>
```{r echo=FALSE}
file <- list.files()
